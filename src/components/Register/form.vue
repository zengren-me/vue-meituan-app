<template>
    ...
    ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item>
            <el-button type="primary" @click="submitForm('ruleForm')">完成注册并登录</el-button>
        </el-form-item>
        <div class="footer">
            ...
            <span>我已阅读并同意
                ...
                <router-link to="/">《隐私政策》</router-link> ，并授权美团使用该美团账号信息（如昵称、头像、收货地址）进行统一管理
            </span>
        </div>
    </el-form>
</template>
...
.el-form {
    ...
    .el-button {
        ...
        color: #222;
        box-shadow: 0px 2px 1px rgba(191, 105, 0, .15);
        border: none;
        font-weight: bold;
    }
    .footer {
